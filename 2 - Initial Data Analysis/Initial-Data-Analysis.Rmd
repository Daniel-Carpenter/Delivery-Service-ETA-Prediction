...
ggplot(df.train.base, aes(x=Multiple_Deliveries, y=Target_Variable)) + 
  geom_boxplot()


ggplot(df.train.base, aes(x=City, y=Target_Variable)) + 
  geom_boxplot()

ggplot(df.train.base, aes(x=Vehicle_Condition, y=Target_Variable)) + 
  geom_boxplot()
```
...
```{r}
# names(df.train.base.numeric)


ggplot(df.train.base, aes(x=Delivery_Person_Ratings, y=Target_Variable)) + 
  geom_point()
```
